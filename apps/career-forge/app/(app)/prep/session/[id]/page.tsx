...
async function SessionPage(props: Props) {
  ...
  return (
    <div className=" rounded-2xl shadow-xl p-8 max-w-2xl mx-auto bg-gradient-to-br from-blue-600/20 to-cyan-600/20 border border-blue-500/30 hover:border-blue-500/50">
      {data.isComplete ? (
