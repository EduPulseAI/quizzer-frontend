...
import type { About, Personal } from '@edupulse/profile';
      ...
      <CardContent className="p-0">
        ...
        <Tabs defaultValue="about" className="w-full" onValueChange={setActiveTab}>
          ...
          <TabsContent value="about" className="p-4 sm:p-6 space-y-4 sm:space-y-6 focus:outline-none">
            <div className="space-y-3">
              ...
              <p className="text-sm">{aboutInfo.summary[0]}</p>
            </div>
            ...
            <div className="space-y-4">
              ...
              {/* <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-400">{personalInfo}</p>
                </div>
              </div>*/}
            </div>
          </TabsContent>
        ...
        <div className="p-3 sm:p-4 border-t border-zinc-800 flex items-center justify-center">
          <div className="flex items-center">
            <span
              className={`w-2 h-2 ${false ? "bg-green-500" : "bg-red-500"} rounded-full mr-2`}
            ></span>
            <span className="text-xs text-zinc-400">
              {false ? "Available for new projects" : "Not available for new projects"}
            </span>
          </div>
        </div>
      </CardContent>
