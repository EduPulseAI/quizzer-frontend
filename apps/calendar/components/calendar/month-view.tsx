...
export function MonthView({ onSelectDate, onSelectEvent }: MonthViewProps) {
        ...
        {days.map((date, i) => {
          ...
          return (
            <div
              ...
              tabIndex={0}
              className={cn(
                "group relative flex flex-col border-b border-r p-1 text-left transition-colors hover:bg-accent/50 md:p-2 cursor-pointer",
              ...
              <div className="flex flex-col gap-0.5">
                {dayEvents.slice(0, 3).map((event) => (
                  <button
                    ...
                    className={cn(
                      "flex items-center gap-1 truncate rounded px-1 py-0.5 text-left text-[10px] font-medium leading-tight md:text-xs",
